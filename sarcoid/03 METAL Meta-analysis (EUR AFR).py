...
get_ipython().system('gsutil ls {output_folder}/afr/condition__sarcoid/gwas_results.tsv.gz')
...
get_ipython().system('gsutil ls {output_folder}/metal/condition__sarcoid/')
