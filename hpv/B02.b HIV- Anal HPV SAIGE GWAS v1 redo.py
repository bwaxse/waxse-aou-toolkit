...
# !gsutil ls {src_bucket}/data/stg009/whole_cohort/


# In[ ]:


# !gsutil ls {my_bucket}/saige_gwas/v1/transancestry/condition__hpv/
...
## output folders
output_folder = f'{my_bucket}/saige_gwas/v1_redo'
    ...
    for anc in ancestries:
        ...
        for chrom in chroms:
            ...
            in_dict = {
                ...
                'INPUT_NULL_RDA': f'{my_bucket}/saige_gwas/v1/{anc}/{trait}/saige_null_model.rda',
                'INPUT_NULL_VARRAT': f'{my_bucket}/saige_gwas/v1/{anc}/{trait}/saige_null_model.varianceRatio.txt',
            }
...
def run_saige_step2_whole_cohort(
    ...
    for chrom in chroms:
        ...
        in_dict = {
            ...
            'INPUT_BIM': f'{plink_base}.bim',
            'INPUT_FAM': f'{plink_base}.fam',
            'INPUT_NULL_RDA': f'{my_bucket}/saige_gwas/v1/transancestry/{trait}/saige_null_model.rda',
            'INPUT_NULL_VARRAT': f'{my_bucket}/saige_gwas/v1/transancestry/{trait}/saige_null_model.varianceRatio.txt',
        }
        ...
        dsub_script(
            label=f'step2_transancestry_chr{chrom}_{trait}',
            machine_type=machine_type,
            envs=env_dict,
            in_params=in_dict,
            out_params=out_dict,
...
run_saige_step2(['eur', 'amr', 'afr'], 'condition__hpv', 'run_saige_chrom_multi.sh', machine_type='c4-standard-8')
...
job_details(job='step2-amr---bwaxse--250625-165743-90')


# In[ ]:


get_ipython().system('gsutil cat {bucket}/dsub/logs/step2-amr-chr22-condition--hpv-run-saige-chrom-multi/bwaxse/20250625/step2-amr---bwaxse--250625-165743-90-task-None.log')


# In[ ]:


run_saige_step2_whole_cohort(
...
job_details(job='step2-tran--bwaxse--250625-165844-79')


# In[ ]:


get_ipython().system('gsutil cat {bucket}/dsub/logs/step2-transancestry-chr22-condition--hpv-run-saige-chrom-multi/bwaxse/20250625/step2-tran--bwaxse--250625-165844-79-task-None.log')


# In[ ]:


get_ipython().system(' gsutil ls {my_bucket}/saige_gwas/v1/eur/condition__hpv/gwas/')


# In[ ]:


get_ipython().system(' gsutil -u $GOOGLE_PROJECT du -h {bucket}/saige_gwas/v1/')
