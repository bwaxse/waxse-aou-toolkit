...
covariates = ['end_of_study_age'] + ['ancPC{}'.format(str(x)) for x in range(1, 21)]
all_covariates = ['end_of_study_age'] + ['PC{}'.format(str(x)) for x in range(1, 17)]
covariates_discrete = []
...
## output folders
output_folder = f'{my_bucket}/saige_gwas/v2'
...
hpv_df = pd.read_csv(f'{my_bucket}/data/cohorts/female_hiv_negative_hpv_gwas_cohort_v2_demographics.tsv', 
                     sep='\t',
                     dtype={'person_id': str})
...
job_details(job='step1-amr---bwaxse--251213-135421-92')


# In[ ]:


log="{bucket}/dsub/logs/step1-amr-run-saige-null-model/bwaxse/20251213/step1-amr---bwaxse--251213-135421-92-task-None.log"
view_dsub_logs(log)
    ...
    for anc in ancestries:
        ...
        for chrom in chroms:
            ...
            in_dict = {
                ...
                'INPUT_NULL_RDA': f'{my_bucket}/saige_gwas/v2/{anc}/{trait}/saige_null_model.rda',
                'INPUT_NULL_VARRAT': f'{my_bucket}/saige_gwas/v2/{anc}/{trait}/saige_null_model.varianceRatio.txt',
            }
...
run_saige_step2(['eur', 'amr', 'afr'], 'condition__hpv', 'run_saige_chrom_multi.sh', machine_type='n2d-standard-8')
...
job_details(job='step2-eur---bwaxse--251213-155233-15')
...
get_ipython().system(' gsutil ls {my_bucket}/saige_gwas/v2/eur/condition__hpv/gwas/')
