...
base_dir = f'{my_bucket}/saige_gwas/v2' # no trailing /
...
args = ["gsutil", "cp", "-r", "./manhattan_plots/", f"{my_bucket}/saige_gwas/v2/"]
...
# move all plots from manhattan_plots to bucket metal folder
args = ["gsutil", "cp", "-r", "./regional_plots/", f"{my_bucket}/saige_gwas/v2/"]
output = subprocess.run(args, capture_output=True)
